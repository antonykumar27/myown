...
const ContentDisplay = () => {
  ...
  const MarkdownComponents = useMemo(
    () => ({
      ...
      iframe: ({ node, src, title, className, style, ...props }) => (
        <div
          className="my-8 relative pb-[56.25%] h-0  rounded-2xl shadow-2xl"
          style={style}
        >
          <iframe
            src={src}
      ...
      video: ({ node, src, className, style, ...props }) => (
        <div className="my-8 rounded-2xl  shadow-2xl" style={style}>
          <video
            src={src}
            controls
  ...
  const engagement = useEngagementTracker(contentRef);
  ...
  return (
    ...
    >
      ...
      {/* Main Container */}
      <div ref={contentRef} className="flex-1  pt-20 pb-20 px-4 scroll-smooth">
        <div
            ...
            {isMarkedCompleted ? (
              ...
              >
                <button
                  ...
                  className="group relative px-12 py-6 bg-slate-900 dark:bg-white dark:text-slate-900 text-white rounded-full font-black text-xl  transition-all hover:scale-105 active:scale-95"
                >
